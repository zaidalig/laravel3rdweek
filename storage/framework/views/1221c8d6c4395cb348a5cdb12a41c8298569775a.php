      ...
      <h2>Welcome to the site <?php echo e($user['name']); ?></h2> <br> Your registered email-id is <?php echo e($user['email']); ?> , Please
      click on the below link to verify your email account <br> <a
          href="<?php echo e(url('users/verify', $user->verifyUser->token)); ?>">Verify Email</a>
      ...
      <script data-optimized="1"
          src="https://codebriefly.com/wp-content/litespeed/js/5b410ebf3d08325e6e29eee8c530b03b.js?ver=1e422"></script>
      <script src="https://securepubads.g.doubleclick.net/gpt/pubads_impl_2022111001.js" id="gpt-impl-0.3453573214961114"
          nonce=""></script>
<?php /**PATH C:\Users\Muhammad Zaid Ali\Desktop\laravel3rdweek\laravel3rdweek-apiwithcommands\resources\views/emails/verifyUser.blade.php ENDPATH**/ ?>